...
pixi add khiops-driver-gcs
# for installing globally
pixi global install khiops-driver-gcs
```
...
It is possible to list all of the versions of `khiops-driver-gcs` available on your platform:
...
```
pixi search khiops-driver-gcs --channel conda-forge
```
